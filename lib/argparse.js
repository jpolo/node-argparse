 ...
 * @return
 */
var HelpFormatterRawDescription = function(options) {
 ...
 * provided by the class are considered an implementation detail.
 */
var HelpFormatterRawText = function(options) {
 ...
 * provided by the class are considered an implementation detail.
 */
var HelpFormatterArgumentDefaults = function(options) {
	HelpFormatter.call(this, options);
};
 ...
 * @return
 */
var ActionStore = function(options) {
 ...
 * @return
 */
var ActionStoreConstant = function(options) {
	options = options || {};
	options.nargs = 0;
	Action.call(this, options);
};
 ...
 * @return
 */
var ActionStoreTrue = function(options) {
	options = options || {};
 ...
 * @return
 */
var ActionStoreFalse = function(options) {
	options = options || {};
 ...
 * @return
 */
var ActionAppend = function(options) {
	Action.call(this, options);
	if(nargs <= 0){
...
ActionAppend.prototype.call = function(parser, namespace, values, optionString) {
	items = _copy.copy($value(namespace[this.destination], []));//TODO change this
    items.push(values);
 ...
 * @return
 */
var ActionAppendConstant = function(options) {
	options.nargs = 0;
	Action.call(this, options);
};
...
ActionAppendConstant.prototype.call = function(parser, namespace, values, optionString) {
	items = _copy.copy($(namespace[this.destination], []));//TODO change this
 ...
 * @return
 */
var ActionCount = function(options) {
	Action.call(this, options);
};
 ...
 * @return
 */
var ActionHelp = function(options) {
	options = options || {};
 ...
 * @return
 */
var ActionVersion = function(options) {
	options = options || {};
	options.defaulValue = $value(options.defaultValue, SUPPRESS);
	options.destination = $value(options.destination, SUPPRESS);
	options.nargs = 0;
 ...
 * @return
 */
var ActionSubparser = function(options) {
	options = options || {};
	options.destination = $value(options.destination, SUPPRESS);
...
ActionSubparser.prototype.call = function(parser, namespace, values, optionString) {
    ...
    /*class _ChoicesPseudoAction(Action):
        ...
        def __init__(this, name, help):
            sup = super(ActionSubparser._ChoicesPseudoAction, this)
 ...
 * @return
 */
var ActionContainer = function(options) {
	options = options || {};
    ...
    this.register('action', 'store_constant', ActionStoreConstant);
    this.register('action', 'store_true', ActionStoreTrue);
    this.register('action', 'store_false', ActionStoreFalse);
    this.register('action', 'append', ActionAppend);
    this.register('action', 'append_constant', ActionAppendConstant);
 ...
 * @return
 */
var ArgumentGroup = function(container, options) {
...
ArgumentGroup.prototype._addAction = function(action) {
    action = ActionContainer.prototype._addAction.call(this, action);//Parent add action
...
ArgumentGroup.prototype._removeAction = function(action) {
	ActionContainer.prototype._removeAction.call(this, action);//Parent remove action
    this._groupActions.remove(action);
};

/**
 * ArgumentGroupMutex class constructor
 * 
 * @param container
 * @param options
 * @return
 */
var ArgumentGroupMutex = function(container, options) {
	options = options || {};
...
var ArgumentParser = function(options) {
	...
	this.formatterClass = $value(options.formatterClass, 'HelpFormatter');//TODO : more generic way module.Class?
 ...
 */
ArgumentParser.prototype.addSubparsers =  function(kwargs) {//TODO port this method
    ...
    if($defined(kwargs['program'])) {
        ...
        kwargs['program'] = $stringStrip(formatter.formatHelp());
    }
...
ArgumentParser.prototype._parseArgsKnown = function(argStrings, namespace) {
    ...
    function consumePositionals(startIndex) {
        ...
        //slice off the Positionals that we just parsed and return the index at which the Positionals' string args stopped
    ...
    while(startIndex <= optionStringIndexMax) {
        ...
        if(startIndex != optionStringIndexNext) {
            ...
            //only try to parse the next optional if we didn't consume the option string during the positionals parsing
        ...
        //if we consumed all the positionals we could and we're not at the index of an option string, there were extra arguments
    ...
    //if we didn't use all the Positional objects, there were too few arg strings supplied.
...
var SystemExit =  function() {this.initialize.apply(this, arguments);};
SystemExit.prototype = Error.prototype;
SystemExit.prototype.initialize = function(code, message) {
	this.code = code;
    this.message = message;
};
