...
RawDescriptionHelpFormatter.prototype = new HelpFormatter;
 ...
 * provided by the class are considered an implementation detail.
 */
var RawTextHelpFormatter = function() {
	this.initialize.apply(this, arguments);
};
RawTextHelpFormatter.prototype = new RawDescriptionHelpFormatter;
RawTextHelpFormatter.prototype._splitLines = function(text, width) {
 ...
 * provided by the class are considered an implementation detail.
 */
var ArgumentDefaultsHelpFormatter = function() {
	this.initialize.apply(this, arguments);
};
ArgumentDefaultsHelpFormatter.prototype = new HelpFormatter;
ArgumentDefaultsHelpFormatter.prototype._getHelpString = function(action) {
    ...
    class _Section(object):
        ...
        def __initialize__(self, formatter, parent, heading=None):
