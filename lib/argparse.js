...
(function(){
	...
	Class.create = function(className, proto) {
		...
		k.__parent__ = this.__name__ ? proto : undefined;
...
/**
 * _ActionContainer class
 * 
 * @param options
 * @return
 */
var _ActionContainer = function(options) {
	options = options || {};
...
_ActionContainer.prototype = {
	...
	addArgumentGroup: function(options, mutuallyExclusive) {
		...
		if(mutuallyExclusive) {
			var group = new _ArgumentGroupMutex(this, options);
 ...
 * @return
 */
var _ArgumentGroup = function(container, options) {
	...
	_ActionContainer.call(this, options);
...
sys.inherits(_ArgumentGroupMutex, _ActionContainer);
 ...
 * @return
 */
_ArgumentGroup.prototype._addAction = function(action) {
    action = _ActionContainer.prototype._addAction.call(this, action);//Parent add action
 ...
 * @return
 */
_ArgumentGroup.prototype._removeAction = function(action) {
	_ActionContainer.prototype._removeAction.call(this, action);//Parent remove action
    this._groupActions.remove(action);
};

/**
 * _ArgumentGroupMutex class constructor
 * 
 * @param container
 * @param options
 * @return
 */
var _ArgumentGroupMutex = function(container, options) {
	options = options || {};
	
	_ArgumentGroup.call(this, container, options);
    this.required = $value(options.required, false);
};
sys.inherits(_ArgumentGroupMutex, _ArgumentGroup);

_ArgumentGroupMutex.prototype._addAction = function(action) {
	if(action.required) {
...
_ArgumentGroupMutex.prototype._removeAction = function(action) {
...
sys.inherits(ArgumentParser, _ActionContainer);
