...
(function(){
	...
	Class.create = function(className, proto) {
		...
		k.prototype.toRepr = function() { return this._toRepr(this, []);};
		k.prototype._toRepr = function(object, references) {
			...
			if(object == undefined) {
				...
				case 'object':
					...
					//var referencesNew = references.concat([this]);
		//console.log(referencesNew);
					if(object instanceof Array) {
						return '[' + object.map(function(value) {
							return k.prototype._toRepr(value, referencesNew);
						}).join(', ')+ ']';
					} else {
						...
						for(var property in object) {
							...
							if((value != undefined) && !(value instanceof Function)) {
								valueString = k.prototype._toRepr(value, referencesNew);
							}
...
var ArgumentParser = _ActionContainer.extend('ArgumentParser', {
	...
	parseArgs: function(args, namespace) {
	    ...
	    var args = result[0], argv = result[1];
